      ...
      <div className="space-y-5">
        <div>
          ...
          <input
            ...
            required
            className="padL magB w-full px-5 py-4 rounded-lg border border-var(--color-primary-light) shadow-sm focus:outline-none focus:ring-2 focus:ring-var(--color-primary) transition"
          />
        </div>
        ...
        <div className="relative">
          ...
          <input
            ...
            required
            className="padL magB w-full px-5 py-4 pr-24 rounded-lg border border-var(--color-primary-light) shadow-sm focus:outline-none focus:ring-2 focus:ring-var(--color-primary) transition"
          />
